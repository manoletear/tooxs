...
const solutions: Solution[] = [
  ...
  },
  {
    ...
    icon: <Wrench size={24} />,
    accentColor: "#20B2AA",
    fullDescription: "XperTooxs unifica mantenimiento y operación en una sola plataforma. Planifica intervenciones, anticipa fallas y transforma la confiabilidad de tus activos en disponibilidad real y mayor producción.",
    problems: [
      "Paradas no planificadas que frenan la producción y disparan costos.",
      "Cero visibilidad del estado real de los activos críticos.",
      "Información fragmentada en planillas, bitácoras de papel y sistemas que no se hablan.",
      "Decisiones de mantenimiento basadas en intuición, no en datos.",
    ],
    benefits: [
      "Más horas de operación efectiva por equipo.",
      "Reducción medible de paradas imprevistas.",
      "Trazabilidad completa de intervenciones, repuestos y costos.",
      "Decisiones respaldadas por KPIs de confiabilidad (MTBF, MTTR, disponibilidad).",
      "Equipos de mantenimiento que dejan de apagar incendios.",
    ],
    steps: [
      { title: "Captura", description: "Registra activos, intervenciones y eventos desde terreno, sensores y sistemas conectados." },
      { title: "Planificación", description: "Programa mantenimientos preventivos y predictivos según criticidad y carga operativa." },
      { title: "Ejecución", description: "Coordina cuadrillas, repuestos y órdenes de trabajo con trazabilidad en línea." },
      { title: "Análisis", description: "Mide KPIs de confiabilidad y productividad para iterar y mejorar continuamente." },
    ],
    integrations: ["ERP", "SCADA", "PLCs", "IoT / Sensores", "CMMS", "Bases de datos"],
