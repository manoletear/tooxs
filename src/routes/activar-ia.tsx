...
export const Route = createFileRoute("/activar-ia")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://tooxs.lovable.app/activar-ia" },
      { property: "og:image", content: "https://tooxs.lovable.app/og-activar-ia.jpg" },
    ...
    links: [{ rel: "canonical", href: "https://tooxs.lovable.app/activar-ia" }],
  }),
