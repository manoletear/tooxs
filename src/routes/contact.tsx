...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://tooxs.lovable.app/contact" },
    ...
    links: [
      { rel: "canonical", href: "https://tooxs.lovable.app/contact" },
    ],
  }),
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right — HubSpot Form */}
            <div className={`bg-white rounded-2xl p-8 md:p-10 shadow-xl transition-all duration-1000 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
              <HubSpotForm />
            </div>
          </div>
        </div>
